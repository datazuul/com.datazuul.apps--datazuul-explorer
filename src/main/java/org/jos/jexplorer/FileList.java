...
public class FileList extends FileComponent implements FileListener, Accessible, FocusListener, DragGestureListener, DragSourceListener, DropTargetListener{
	...
	/**
	 * La carpeta de inicio por defecto. En un futuro se deber� recoger� de un fichero de propiedades o desaparecer.
	...
	/**
	 * Tipo de ordenaci�n con la que se muestran los ficheros. Sus valores posibles son 
	...
	/**
	 * Mantiene el camino que se ha seguido. Lo utiliza la funci�n goBack().
	 */
	private Stack backStack = new Stack();

	/**
	 * Mantiene el camino que se ha seguido. Lo utiliza la funci�n goForward().
	 */
	...
	/**
	 * Panel donde se visualizar�n los ficheros.
	 */
	 ...
	 * ra�z del sistema y la vista de Iconos grandes.
	 */
	public FileList(){
		this(DEFAULT_FILE);
	}
	 ...
	 * @param folder La nueva carpeta de la cual se mostrar� el contenido
	 */
	...
	/**
	 * Cambia la carpeta de la cual se est� visualizando su contenido. Esta operaci�n hace
	 * que se refresque la pantalla. Este m�todo no lanza el <i>fireChangeListener</i>
	 * @param folder La nueva carpeta a visualizar su contenido.
	 * @param back Si es true la carpeta antigua se a�adir� a la pila de vuelta atras.
	 * @param back false en el caso de la funci�n setBack, ya que no se quiere que esta acci�n se a�ada en la pila de marcha atras.
	 */
	...
	/**
	 * Cambia la carpeta de la cual se est� visualizando el contenido. A su vez
	...
	/**
	 * Devuleve la carpeta de la cual se est� visualizando su contenido.
	 * @return la carpeta de la cual se est� visualizando el contenido.
	 */
	 ...
	 * @param viewType El modo de visualizaci�n que se quiere poner.
	 */
	 ...
	 * @return El modo de visualizaci�n actual.
	 */
	...
	/**
	 * Cambia el tipo de ordenaci�n del contenido de la carpeta actual. Refresca la pantalla.
	 * Los posibles son ORDER_BY_NAME, ORDER_BY_SIZE u ORDER_BY_DATE.
	 * @param orderBy El modo de ordenaci�n que se quiere poner.
	 */
	...
	/**
	 * Devuleve el tipo ordenaci�n. Los posibles son ORDER_BY_NAME, ORDER_BY_SIZE u ORDER_BY_DATE.
	 * @return true si la ordenaci�n se hace inversamente.
	 */
	...
	/**
	 * Cambia el tipo de ordenaci�n del contenido de la carpeta actual. Refresca la pantalla.
	 * @param orderBy El modo de ordenaci�n que se quiere poner. Los posibles son ORDER_BY_NAME, ORDER_BY_SIZE u ORDER_BY_DATE.
	 * @param inverse ser� verdadero si la ordenaci�n se ha de invertir.
	 */
	...
	/**
	 * Cambia la ordenaci�n, para que sea inversa o no.
	 * @param inverse verdadero para que la ordenaci�n se invierta.
	 */
	...
	/**
	 * Refresca el contenido de la pantalla. Mostrar� el contenido de la carpeta actual
	 * con el tipo de vista y la ordenaci�n actuales.
	 * @param clearSelectionModel si es <i>true</i> limpia la selecci�n de ficheros
	...
	/**
	 * Selecciona todos los ficheros que se est�n mostrando en la actualidad.
	 */
