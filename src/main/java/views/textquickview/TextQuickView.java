package views.textquickview;

/*
 * TextQuickView.java - Text plain view for JExplorer
 ...
 */
public class TextQuickView implements QuickView {
	...
	public TextQuickView() {
		logo = I18n.getImageIcon(this, "images/logo.gif");
	}

	/**
	 * Creates the TextQuickView gui.
	 */
